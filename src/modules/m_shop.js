  ...
  new Promise((resolve, reject) => {
    ...
    conn.beginTransaction((beginError) => {
      ...
      const shopPayload = {
        ...
        shop_naf: data.shop_naf,
        shop_vat_number: data.shop_vat_number,
        receipt_review_qr_url: data.receipt_review_qr_url,
        receipt_review_qr_label: data.receipt_review_qr_label,
        cash_register_number: data.cash_register_number,
        admin_user: 0,
  ...
  new Promise((resolve, reject) => {
    ...
    const sql = `
      ...
      SET shop_name = ?, shop_description = ?, shop_phone = ?, shop_adress = ?,
          shop_siret = ?, shop_naf = ?, shop_vat_number = ?,
          receipt_review_qr_url = ?, receipt_review_qr_label = ?, cash_register_number = ?,
          activate_tva = ?, hours = ?, shop_social_media = ?,
          shop_payment_methods = ?, shop_profile_image = ?, shop_theme = ?, shop_status = ?,
    ...
    const values = [
      ...
      data.shop_siret,
      data.shop_naf,
      data.shop_vat_number,
      data.receipt_review_qr_url,
      data.receipt_review_qr_label,
      data.cash_register_number,
      data.activate_tva,
