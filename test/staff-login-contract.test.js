...
assert.match(moduleSource, /assigned_point\.id AS service_point_id/)
assert.match(moduleSource, /assigned_point\.type AS service_point_type/)
assert.doesNotMatch(moduleSource, /counter\.id AS service_point_id/)
