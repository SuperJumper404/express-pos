...
assert.match(moduleSource, /counter\.id AS service_point_id/)
assert.match(moduleSource, /counter\.system_key = ['"]counter['"]/)
assert.match(moduleSource, /counter\.is_active = 1/)
